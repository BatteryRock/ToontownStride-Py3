...
class ToontownLoadingScreen:
    def __init__(self):
        ...
        self.__count = 0
        self.textures = [
            (loader.loadTexture('phase_3.5/maps/loading/toon.jpg'), ToontownGlobals.getInterfaceFont(), (0, 0, 0.5, 1)),
        ...
        self.title = DirectLabel(
            ...
            parent=self.gui, relief=None,
            pos=(base.a2dRight/5, 0, 0.235),
            text='', textMayChange=1,
            text_scale=0.08, text_fg=(0, 0, 0.5, 1),
            text_align=TextNode.ALeft, text_font=ToontownGlobals.getInterfaceFont()
        )
        self.tip = DirectLabel(
            ...
            pos=(0, 0, 0.045),
            text='', textMayChange=1,
            text_scale=0.05, text_fg=(1, 1, 1, 1),
    ...
    def _setupNoGui(self):
        self.title.reparentTo(base.a2dpBottomLeft, LOADING_SCREEN_SORT_INDEX)
        self.gui.reparentTo(hidden)
        self.logo.reparentTo(hidden)

    def _cleanupAfterLoading(self):
